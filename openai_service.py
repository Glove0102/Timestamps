...
- Timestamp descriptions should be detailed and authentic to the content (80-140 characters)
- Focus on meaningful content transitions, not minor topic shifts
- Include 3-15 topic segments depending on content length. More segments for longer content.
- The starting timestamp should be "0:00:00" if that's the initial time in the file, or begin at the first time point provided by the SRT file.
